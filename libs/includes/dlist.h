 ...
 *
 * @param head A pointer to the head of the linked list.
 * @param func A function that takes two void pointers as arguments and returns
 * void.
 * @param param A pointer to a parameter that will be passed to the function.
 *
 * @warning The function assumes that the given list is valid with a NULL at
 * the end. If this is not the case, the behavior is undefined.
*/
 ...
 *
 * @param head A pointer to the head of the linked list.
 * @param func A function that takes a lnode_t pointer as an argument
 * and returns void.
 *
 * @warning The function assumes that the given list is valid with a NULL at
 * the end. If this is not the case, the behavior is undefined.
